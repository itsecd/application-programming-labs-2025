        ...
        try:
            ...
            if show_plot and MATPLOTLIB_AVAILABLE:
                self.visualize_audio(
                    audio_data, reversed_audio, sample_rate,
    ...
    def visualize_audio(self, original_audio, reversed_audio, sample_rate,
        ...
        try:
            ...
            if original_audio.ndim == 1:  # Моно
                ...
                ax1.plot(
                    time_original, original_audio[:, 0], color='blue',
                    linewidth=0.5, alpha=0.7, label='Левый канал'
                )
                ax1.plot(
                    time_original, original_audio[:, 1], color='red',
            ...
            if reversed_audio.ndim == 1:  # Моно
                ...
                ax2.plot(
                    time_reversed, reversed_audio[:, 0], color='green',
                    linewidth=0.5, alpha=0.7, label='Левый канал'
                )
                ax2.plot(
                    time_reversed, reversed_audio[:, 1], color='orange',
                    linewidth=0.5, alpha=0.7, label='Правый канал'
                )
                ax2.legend()
