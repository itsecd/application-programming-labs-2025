...
def main():
    try:
        ...
        parser.add_argument("ranges", nargs='+', type=parse_size_range, help="Диапазоны размеров изображений в формате: minWxminH-maxWxmaxH. Например: 100x100-300x300 500x500-800x800")
