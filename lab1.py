...
def get_args() -> str:
    parser = argparse.ArgumentParser(prog = 'Обработка текстовых данных ')  # создание экземпляра парсера
    parser.add_argument('filename', type=str, help='filename')  # добавление позиционного аргумента командной строки
    parser.add_argument('output_filename', type=str, help='output_filename')  # имя выходного файла
