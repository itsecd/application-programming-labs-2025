...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Переворачивание аудиофайла задом наперед')
    ...
    if not args.input_file.lower().endswith(('.wav', '.flac', '.ogg')):
        ...
        print("Для MP3 рекомендуется использовать другие библиотеки или конвертировать в WAV")
