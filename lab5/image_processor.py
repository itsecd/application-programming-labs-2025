...
class ImageProcessor:
    ...
    def _load_image(self) -> np.ndarray:
        """
        Защищённый метод для загрузки изображения с помощью OpenCV.
    ...
    def _center_crop_to_square(self, image: np.ndarray) -> np.ndarray:
        """
        Защищённый метод для обрезки изображения до квадрата по центру.
    ...
    def _convert_for_matplotlib(self, image_data: np.ndarray) -> np.ndarray:
        """
        Защищённый метод для конвертации изображения из формата OpenCV (BGR/BGRA)
