...
class BearImageDownloader:
    ...
    def download_images(self, date_ranges: List[Tuple[str, str]], images_per_range: List[int], output_dir: str) -> List[str]:
        ...
        print(f"Целое количество: {total_target} изображений медведей")
        
        all_images = []
        
        for range_idx, (start_date, end_date) in enumerate(date_ranges): #date_ranges [['2023-01-01', '2023-01-07'], ['2023-01-08', '2023-01-14']]
                                                                         #enumerate(date_ranges)*(0, ['2023-01-01', '2023-01-07']) *(1, ['2023-01-08', '2023-01-14'])
            ...
            downloaded = self._download_for_range(start_date, end_date, target_count, range_dir)
    ...
    def _download_for_range(self, start_date: str, end_date: str, target_count: int, output_dir: str) -> List[str]:
        ...
        for keyword in self.bear_keywords:
            ...
            try:
                search_queries = [f"{keyword} after:{start_date} before:{end_date}", keyword]
